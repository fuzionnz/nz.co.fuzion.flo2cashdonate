 ...
 */
function flo2cashdonate_civicrm_xmlMenu(&$files) {
  _flo2cashdonate_civix_civicrm_xmlMenu($files);
}
 ...
 */
function flo2cashdonate_civicrm_managed(&$entities) {
  _flo2cashdonate_civix_civicrm_managed($entities);
}
 ...
 */
function flo2cashdonate_civicrm_caseTypes(&$caseTypes) {
  _flo2cashdonate_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function flo2cashdonate_civicrm_angularModules(&$angularModules) {
  _flo2cashdonate_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function flo2cashdonate_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
  _flo2cashdonate_civix_civicrm_alterSettingsFolders($metaDataFolders);
}
 ...
 *
function flo2cashdonate_civicrm_preProcess($formName, &$form) {
