...
function flo2cashdonate_civicrm_install() {
  return _flo2cashdonate_civix_civicrm_install();
}
...
function flo2cashdonate_civicrm_uninstall() {
  return _flo2cashdonate_civix_civicrm_uninstall();
}
...
function flo2cashdonate_civicrm_enable() {
  return _flo2cashdonate_civix_civicrm_enable();
}
...
function flo2cashdonate_civicrm_disable() {
  return _flo2cashdonate_civix_civicrm_disable();
}
...
function flo2cashdonate_civicrm_managed(&$entities) {
  return _flo2cashdonate_civix_civicrm_managed($entities);
}
/**
 * Payment class for Flo2Cash Donate.
 */

class nz_co_fuzion_flo2cashdonate extends CRM_Core_Payment {
  ...
  static function &singleton($mode, &$paymentProcessor) {
    ...
    if (self::$_singleton[$processorName] === null) {
      self::$_singleton[$processorName] = new nz_co_fuzion_flo2cashdonate($mode, $paymentProcessor);
    }
...
//    $notifyURL = 'https://crm.dev.greens.org.nz/ipn';
  ...
  function handlePaymentNotification() {
    ...
    nz_co_fuzion_Flo2CashDonateIPN::main();
  }
